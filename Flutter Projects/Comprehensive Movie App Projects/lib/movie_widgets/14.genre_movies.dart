...
// secilen genre ye , kategoriye, ilgili filmi getirsin
...
class _GenreMoviesState extends State<GenreMovies> {
  ...
  Widget _buildMoviesByGenreWidget(MovieModel data) {
    ...
    if (movies!.isEmpty) {
      ...
      //else kısmı movie posterini ve rating (yildiz derecelendirme) döndürcek
      return Container(  // yatay kaydırılabilir liste 
        height: 270,
  ...
  //etkileşimli bi arayüzü istedigim için kullandım. GestureDetector metodu sayesinde
  //bi film ögesine tıklayınca detay ekranina geçiş yapicam.Dokunma okayını algılar
                 onTap: () {
                ...
                child: Column(
                  children: <Widget>[
                    movies[index].poster == null
                        ? Container( // eger poster null döndürürse, videocam_off icons dönsün 
                            width: 120,
                            height: 180,
